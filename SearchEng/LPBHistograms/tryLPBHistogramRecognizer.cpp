#include "tryLPBHistogramRecognizer.h"
using namespace cv;
using namespace std;
...
void TryLPBHistogramRecognizer::processMatching(const std::string& strTargetCSV
...
void TryLPBHistogramRecognizer::GetFileList(const path& root
...
cv::Mat TryLPBHistogramRecognizer::norm_0_255(InputArray _src){
    Mat src = _src.getMat();
...
void TryLPBHistogramRecognizer::read_csv(const std::string& filename
...
void TryLPBHistogramRecognizer::OutputResult(const std::string& strResultPath, const int& nThreshold){
