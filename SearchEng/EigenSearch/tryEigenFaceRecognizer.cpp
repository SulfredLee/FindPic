#include "tryEigenFaceRecognizer.h"
using namespace cv;
using namespace std;
...
void TryEigenFaceRecognizer::processMatching(const std::string& strTargetCSV
...
void TryEigenFaceRecognizer::GetFileList(const path& root
...
cv::Mat TryEigenFaceRecognizer::norm_0_255(InputArray _src){
    Mat src = _src.getMat();
...
void TryEigenFaceRecognizer::read_csv(const std::string& filename
...
void TryEigenFaceRecognizer::OutputResult(const std::string& strResultPath, const int& nThreshold){
